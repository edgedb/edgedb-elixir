...
defimpl EdgeDB.Protocol.Codec, for: EdgeDB.Protocol.Codecs.Set do
  ...
  def encode(_codec, %EdgeDB.Set{}, _codec_storage) do
    raise EdgeDB.InvalidArgumentError.new("value can not be encoded as set: set encoding is not supported")
  end

  @impl Codec
  def encode(_codec, value, _codec_storage) do
    raise EdgeDB.InvalidArgumentError.new("value can not be encoded as set: #{inspect(value)}")
  end
