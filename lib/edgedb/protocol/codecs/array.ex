defmodule EdgeDB.Protocol.Codecs.Array do
  ...
  @spec encode_array(list(), list(Types.Dimension.t()), Codec.t()) :: iodata()

  defp encode_array([], _dimensions, _codec) do
    @empty_list_iodata
  end

  defp encode_array(instance, dimensions, codec) when is_list(instance) do
  ...
  @spec decode_array(bitstring(), list(Types.Dimension.t()), Codec.t()) :: list()

  defp decode_array(<<0::int32, _reserved0::int32, _reserved1::int32>>, _dimensions, _codec) do
    []
  end
  ...
  @spec encode_data_into_array_elements(list(), Codec.t()) :: list(Types.ArrayElement.t())
  defp encode_data_into_array_elements(list, %Codec{encoder: encoder}) do
  ...
  @spec transform_in_dimensions(list(), list(Types.Dimension.t())) :: list()
